    ...
    <div>
      <section className="hero">
        <div className="hero-introduction flex">
          <h2>Loan Do Cakes</h2>
          <p>
            A unique dessert to wow your guests at parties. <br /> A scrumptious
        ...
        <div className="hero-images">
          <img className="hero-cake" src={heroimg} alt="koi pond jelly cake" />
        </div>
      </section>
        ...
        <div className="about-text flex">
          ...
          <div className="about-health">
            ...
            <p>
              ...
              seaweed which has zero fat, cholesterol, or sodium. Both our jelly
              and buttercream cakes are also low in sugar. If you are craving a
              healthy
          ...
          <div className="about-unique">
            <h3>Wow Factor</h3>
            <p>
              We don't do basic here. Each cake is an edible art piece made with
              love and care. Perfect for birthdays, family gatherings, and
              parties. Make your gatherings that much more memorable with our
              cakes.
            </p>
          </div>
        </div>
